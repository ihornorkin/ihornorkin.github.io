...
;(function(self) {
  ...
  function createParticles() {
    ...
    for(var quantity = 0, len = 150; quantity < len; quantity++) {
  ...
  function updateText() {
    ...
    context.font = 80 + 'px Arial, sans-serif';
  ...
  function updateTransition() {
    ...
    [].forEach.call(particles, function(particle, index) {
      ...
      switch(currentTransition) {
        ...
        case 'circle':
          ...
          shape.x = canvas.width * 0.5 + 260 * Math.sin(particle.steps);
          shape.y = 180 + 260 * Math.cos(particle.steps);
      ...
      if(!particle.interactive) {
        ...
        particle.y += (((shape.y + Math.sin(particle.angle) * 5) - particle.y) * 0.08) + 8;
    ...
    [].forEach.call(nextText, function(particle, index) {
      ...
      if(!text[index].interactive) {
        ...
        text[index].y += (((particle.y + Math.sin(particle.angle + index) * particle.orbit) - text[index].y) * 0.08) + 2;
